...
KEY, first_name VARCHAR(64) NOT NULL,
last_name VARCHAR(64) NOT NULL,
gpa real,
major VARCHAR(16) NOT NULL, classification
VARCHAR(10) NOT NULL,
...
CREATE TABLE Class ( code VARCHAR(10)
PRIMARY KEY, name VARCHAR(64),
description VARCHAR(1024)
);
CREATE TABLE Enrollment (
student_id INT, class_code
VARCHAR(10), semester
VARCHAR(6) NOT NULL,
year INT NOT NULL, grade
CHAR(1),
